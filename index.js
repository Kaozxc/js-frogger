...
function moveFrog(e) {
    ...
    switch (e.key) {
        case 'ArrowLeft':
            if (currentIndex % boardWidth !== 0) currentIndex -= 1;
            break;
        case 'ArrowRight':
            if (currentIndex % boardWidth < boardWidth - 1) currentIndex += 1;
            break;
        case 'ArrowUp':
            if (currentIndex - boardWidth >= 0) currentIndex -= boardWidth;
            break;
        case 'ArrowDown':
            if (currentIndex + boardWidth < boardWidth * boardWidth) currentIndex += boardWidth;
            break;
    }
